...
public class PermutationPSO extends AbstractParticleSwarmOptimization<PermutationSolution<Integer>, PermutationSolution<Integer>> {
     ...
     */
    public PermutationPSO(PermutationProblem<PermutationSolution<Integer>> problem, int objectiveId, int swarmSize, int maxIterations,
     ...
     * @param evaluator
     */
    public PermutationPSO(PermutationProblem<PermutationSolution<Integer>> problem, int swarmSize, int maxIterations,
                  int numberOfParticlesToInform, SolutionListEvaluator<PermutationSolution<Integer>> evaluator, int numberOfTestCases) {
