...
import org.uma.jmetal.bzu.algorithms.BZUPSO;
...
public class TestCaseRunner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        problem = new TestCasePrioritization("C:\\Users\\awad\\Downloads\\For Hadi\\SBSE\\jMetal-master\\jmetal-problem\\src\\main\\resources\\bzudata\\bash");

        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");
        crossover = new PMXCrossover(0.75);
        mutation = new PermutationSwapMutation<Integer>(0.25);
        ...
        if(ga  == 1){
             ...
             evaluaions = ((BZUPSO) algorithm).getNumberOfEvaluations();
        }
